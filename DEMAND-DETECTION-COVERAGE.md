...
| Games/creative/media/design      | Unity, Unreal, Godot, RenPy, design systems, media/audio/video/VFX assets                                                                                       | project files, artifact extensions, package dependencies                                                                           | `detection-fixtures.ts`, `technology-signatures.test.ts`                   |
