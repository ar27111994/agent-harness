...
void test(
  "readSharedMcpAssetIds returns sorted mcp-server asset IDs from valid manifests",
  async () => {
...
void test(
  "readSharedMcpAssetIds skips packages whose manifestPath is outside install root (path traversal)",
  async () => {
...
void test(
  "readSharedMcpAssetIds returns empty array when no activation manifest exists",
  async () => {
...
void test(
  "readSharedMcpAssetIds ignores packages not in activeAssets",
  async () => {
...
void test(
  "readSharedMcpAssetIds returns IDs sorted alphabetically",
  async () => {
